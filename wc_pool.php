...
class WC_Pool {
  ...
  public function displayGroups() {
    ...
    echo '<tr><td '.self::inORout(CZECH).'>CZECHIA'.self::getIndPointsFormatted(CZECH).'</td></tr>';
    ...
    echo '<tr><td '.self::inORout(BRAHIM).'>BRAHIM DIAZ'.self::getIndPointsFormatted(BRAHIM).'</td></tr>';
