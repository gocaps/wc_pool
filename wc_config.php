...
/*************************************************/
//A
define('SPAIN_WINS', 21);    define('SPAIN_TIES', 1);    define('SPAIN_BONUS', 3);
define('FRANCE_WINS', 18);   define('FRANCE_TIES', 0);   define('FRANCE_BONUS', 0);
define('ENGLAND_WINS', 18);    define('ENGLAND_TIES', 1);    define('ENGLAND_BONUS', 0);
define('SPAIN_OUT', 1);    define('FRANCE_OUT', 1);   define('ENGLAND_OUT', 1);
...
define('ARGENTINA_WINS', 21);	define('ARGENTINA_TIES', 0);	define('ARGENTINA_BONUS', 3);
...
define('BRAZIL_OUT', 1);    define('ARGENTINA_OUT', 1); define('PORTUGAL_OUT', 1);    define('GERMANY_OUT', 1);
...
/*************************************************/
//C
define('BELGIUM_WINS', 9);		define('BELGIUM_TIES', 2);		define('BELGIUM_BONUS', 0);
...
define('NORWAY_WINS', 12);  define('NORWAY_TIES', 0);   define('NORWAY_BONUS', 3);
define('BELGIUM_OUT', 1);		define('HOLLAND_OUT', 1);  define('COLOMBIA_OUT', 1);   define('NORWAY_OUT', 1);
...
/*************************************************/
//D
define('MEXICO_WINS', 12);   define('MEXICO_TIES', 0);   define('MEXICO_BONUS', 0);
...
define('SWITZ_WINS', 12);    define('SWITZ_TIES', 1);    define('SWITZ_BONUS', 3);
define('MEXICO_OUT', 1);   define('MOROCCO_OUT', 1);  define('URUGUAY_OUT', 1);   define('SWITZ_OUT', 1);
...
define('USA_WINS', 9);      define('USA_TIES', 0);      define('USA_BONUS', 3);
define('TURKEY_WINS', 3);      define('TURKEY_TIES', 0);      define('TURKEY_BONUS', 0);
define('ECUADOR_OUT', 1);   define('JAPAN_OUT', 1);  define('USA_OUT', 1);   define('TURKEY_OUT', 1);
...
define('CANADA_WINS', 6);    define('CANADA_TIES', 1);    define('CANADA_BONUS', 3);
define('AUSTRIA_WINS', 3);    define('AUSTRIA_TIES', 1);    define('AUSTRIA_BONUS', 0);
define('CROATIA_OUT', 1);   define('IVORY_OUT', 1);  define('CANADA_OUT', 1);   define('AUSTRIA_OUT', 1);
...
define('SWEDEN_WINS', 3);   define('SWEDEN_TIES', 1);   define('SWEDEN_BONUS', 3);
...
define('SENEGAL_OUT', 1);     define('SWEDEN_OUT', 1);     define('SCOTLAND_OUT', 1);    define('CZECH_OUT', 1);
...
define('EGYPT_WINS', 6);    define('EGYPT_TIES', 2);    define('EGYPT_BONUS', 3);
define('ALGERIA_OUT', 1);     define('KOREA_OUT', 1);     define('PARAGUAY_OUT', 1);    define('EGYPT_OUT', 1);
...
/*************************************************/
//I
define('AUSTRALIA_WINS', 3);	define('AUSTRALIA_TIES', 1);	define('AUSTRALIA_BONUS', 3);
define('IRAN_WINS', 0);			define('IRAN_TIES', 3);			define('IRAN_BONUS', 0);
define('BOSNIA_WINS', 3);		define('BOSNIA_TIES', 1);		define('BOSNIA_BONUS', 3);
define('GHANA_WINS', 3);		define('GHANA_TIES', 1);		define('GHANA_BONUS', 3);
define('AUSTRALIA_OUT', 1);		define('IRAN_OUT', 1);			define('BOSNIA_OUT', 1);		define('GHANA_OUT', 1);
...
/*************************************************/
//J
define('MBAPPE_GOALS', 20);   define('MBAPPE_BONUS', 3);
define('KANE_GOALS', 12);    define('KANE_BONUS', 0);
define('MBAPPE_OUT', 1);     define('KANE_OUT', 1);
...
/*************************************************/
//K
define('MESSI_GOALS', 16);		define('MESSI_BONUS', 3);
...
define('MESSI_OUT', 1);			define('HAALAND_OUT', 1);
define('OYARZABAL_OUT', 1);  define('LAMAL_OUT', 1);
...
define('DEMBELE_GOALS', 10);		define('DEMBELE_BONUS', 3);
define('VINI_OUT', 1);		define('RONALDO_OUT', 1);
define('RAPHINHA_OUT', 1);		define('DEMBELE_OUT', 1);
...
/*************************************************/
//M
define('MARTINEZ_GOALS', 8);		define('MARTINEZ_BONUS', 3);
...
define('MARTINEZ_OUT', 1);		define('ALVAREZ_OUT', 1);
define('GAKPO_OUT', 1);		define('LUKAKU_OUT', 1);
...
/*************************************************/
//N
define('HAVERTZ_GOALS', 6);		define('HAVERTZ_BONUS', 3);
define('MALEN_GOALS', 0);		define('MALEN_BONUS', 0);
define('SAKA_GOALS', 6);		define('SAKA_BONUS', 3);
define('OLISE_GOALS', 0);		define('OLISE_BONUS', 0);
define('HAVERTZ_OUT', 1);		define('MALEN_OUT', 1);
define('SAKA_OUT', 1);		define('OLISE_OUT', 1);
...
define('DIAZ_GOALS', 2);		define('DIAZ_BONUS', 3);
define('SUAREZ_GOALS', 0);	define('SUAREZ_BONUS', 0);
define('TORRES_GOALS', 2);		define('TORRES_BONUS', 3);
define('BRUNO_OUT', 1);		define('DIAZ_OUT', 1);
define('SUAREZ_OUT', 1);		define('TORRES_OUT', 1);
...
define('BELLINGHAM_GOALS', 14);		define('BELLINGHAM_BONUS', 3);
define('ISAK_GOALS', 2);		define('ISAK_BONUS', 0);
define('MUSIALA_GOALS', 2);		define('MUSIALA_BONUS', 0);
define('GIMENEZ_OUT', 1);		define('BELLINGHAM_OUT', 1);
define('ISAK_OUT', 1);		define('MUSIALA_OUT', 1);
...
define('NEYMAR_GOALS', 2);		define('NEYMAR_BONUS', 3);
define('DEBRUYNE_GOALS', 2);		define('DEBRUYNE_BONUS', 3);
define('PULISIC_GOALS', 0);		define('PULISIC_BONUS', 0);

define('WIRTZ_OUT', 1);			define('NEYMAR_OUT', 1);
define('DEBRUYNE_OUT', 1);		define('PULISIC_OUT', 1);
...
/*************************************************/
//R
define('BALOGUN_GOALS', 6);   define('BALOGUN_BONUS', 3);
...
define('BALOGUN_OUT', 1);     define('NUNEZ_OUT', 1);
define('MANE_OUT', 1);    define('SALAH_OUT', 1);
...
define('MAHREZ_GOALS', 4);		define('MAHREZ_BONUS', 3);
define('RODRIGUEZ_GOALS', 0);		define('RODRIGUEZ_BONUS', 0);
define('VALENCIA_GOALS', 0);   define('VALENCIA_BONUS', 0);
define('SCHICK_OUT', 1);		define('LARSEN_OUT', 1);
define('MAHREZ_OUT', 1);		define('RODRIGUEZ_OUT', 1);   define('VALENCIA_OUT', 1);
...
define('UEDA_GOALS', 4);	define('UEDA_BONUS', 3);
define('EMBOLO_GOALS', 4);	define('EMBOLO_BONUS', 3);
define('KRAMARIC_GOALS', 0);  define('KRAMARIC_BONUS', 0);
define('MCTOMINAY_OUT', 1);		define('BRAHIM_OUT', 1);
define('UEDA_OUT', 1);		define('EMBOLO_OUT', 1);    define('KRAMARIC_OUT', 1);
