...
define('LAST_UPDATE', 'England vs Ukraine');
...
define('ITALY_WINS', 15);		define('ITALY_TIES', 0);		define('ITALY_BONUS', 0);
...
define('DENMARK_OUT', 0);			define('CROATIA_OUT', 1);		define('UKRAINE_OUT', 1);
