...
define('PERSIE_GOALS', 8);		define('PERSIE_BONUS', 0);
define('FALCAO_GOALS', 0);		define('FALCAO_BONUS', 0);
define('HIGUAIN_OUT', 0);		define('DCOSTA_OUT', 1);		define('PERSIE_OUT', 1);		define('FALCAO_OUT', 1);
